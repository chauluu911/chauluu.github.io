...
<div class="product-main">
    <h1 style="font-weight: bold; color:rgb(82, 81, 81); " class="title-product">CONVERSE</h1>
<div id="1stRange">
    <ul type="none">
        <!-- Sản phẩm 7 -->
        <li>
          <div id="adidas-product-card">
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <img id="product-img" src="image/converse/AllStarDisruptCX.jpg">
                </a>
              </div>
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <div id="product-detail-main">
                    ...
                    <div id="product-price" value=1680000> 1 550 000đ </div>
        ...
        <li>
          <div id="adidas-product-card">
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <img id="product-img" src="image/converse/Chuck70Black.png">
                </a>
              </div>
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <div id="product-detail-main">
                    ...
                    <div id="product-price" value=1680000> 1 880 000đ </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 product2" id="buy">
                        <a href="#">
                            <button type="button" class="btn btn-outline-secondary" style="padding: 1px;font-size: 13px;width: 145px;;color: black; font-weight: bold;">Thêm vào giỏ hàng</button>
                        </a>
  ...
  <ul type="none">
      ...
      <li>
          <div id="adidas-product-card">
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <img id="product-img" src="image/converse/Chuck70FlameLow.jpg">
                </a>
              </div>
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <div id="product-detail-main">
                    <span id="product-name"> Chuck 70 Flame Low </span>
      ...
      <li>
          <div id="adidas-product-card">
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <img id="product-img" src="image/converse/Chuck70SignatureLow.jpg">
                </a>
              </div>
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <div id="product-detail-main">
                    <span id="product-name"> Chuck 70 Signature Low </span>
                    <div id="product-price" value=4200000> 2 200 000đ </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 product2" id="buy">
                        <a href="#">
                            <button type="button" class="btn btn-outline-secondary" style="padding: 1px;font-size: 13px;width: 145px;;color: black; font-weight: bold;">Thêm vào giỏ hàng</button>
                        </a>
    ...
    <ul type="none">
        ...
        <li>
          <div id="adidas-product-card">
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <img id="product-img" src="image/converse/ChuckTaylorAllStarCXIB.jpg">
                </a>
              </div>
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <div id="product-detail-main">
                    <span id="product-name"> Chuck Taylor All Star CXIB </span>
                    <div id="product-price" value=5000000> 5 600 000đ </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 product2" id="buy">
                        <a href="#">
                            <button type="button" class="btn btn-outline-secondary" style="padding: 1px;font-size: 13px;width: 145px;;color: black; font-weight: bold;">Thêm vào giỏ hàng</button>
                        </a>
        ...
        <!-- Sản phẩm 2 -->
          ...
          <div id="adidas-product-card">
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <img id="product-img" src="image/converse/ChuckTaylorAllStarLogoPlay.jpg">
                </a>
              </div>
              <div>
                <a id="asset-link" href="#" target="_blank">
                  <div id="product-detail-main">
                    <span id="product-name"> Chuck Taylor All Star Logo Play </span>
                    <div id="product-price" value=6000000> 5 500 000đ </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 product2" id="buy">
                        <a href="#">
                            <button type="button" class="btn btn-outline-secondary" style="padding: 1px;font-size: 13px;width: 145px;;color: black; font-weight: bold;">Thêm vào giỏ hàng</button>
                        </a>
